...
- [cite_start] LLM 기반 Query Set 생성, Top-k 변화에 따른 Recall@K 측정, AI 자동 평가 시스템 구축

### [04_Optimization] - Task 4
- [cite_start] ollama 기반 임베딩 자동화, Reranking 로직 검토, 배치 프로세싱을 통한 속도 개선
